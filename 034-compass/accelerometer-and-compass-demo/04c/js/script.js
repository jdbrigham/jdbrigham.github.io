       ...
       // Add a listener to get smartphone orientation 
           // in the alpha-beta-gamma axes (units in degrees)
            window.addEventListener('deviceorientation',(event) => {
				...
				document.getElementById('myDirection').innerHTML = "rotation_degrees:" +direction;
...
window.navigator.geolocation.getCurrentPosition(function(pos) {
  ...
  document.getElementById('myAngle').innerHTML = "In this direction: " + angleToLake + "&deg;";
	
  document.getElementById('textonpath').style.transform = 'rotate('+angleToLake+'deg)';
});
