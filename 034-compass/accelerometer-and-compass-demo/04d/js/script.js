       ...
       // Add a listener to get smartphone orientation 
           // in the alpha-beta-gamma axes (units in degrees)
            window.addEventListener('deviceorientation',(event) => {
				...
				document.getElementById('rotationDegrees').innerHTML =  rotation_degrees+ "&deg;";
				
				document.getElementById('rotationDegrees').innerHTML =  rotation_degrees_value + "&deg;";
				window.addEventListener('deviceorientation', function(e) {
    			console.log(e.webkitCompassHeading);
				}, false);
				
				var direction = degToCompass(rotation_degrees)
				 document.getElementById('direction_value').innerHTML = "direction = " + direction;
...
window.navigator.geolocation.getCurrentPosition(function(pos) {
  ...
  document.getElementById('myAngle').innerHTML =  angleToLake + "&deg;";
